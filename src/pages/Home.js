    ...
    >
      ...
      <div className={`${prefix}description-container`}>
        <div className={`${prefix}description`}>
          <h1>DESIGNING FOR THE ULTIMATE</h1>
          <p>
            With the passion for sport cars since young, I always have the dream
            to design and build my own sport car. Everything starts at the age
            of 3, when my dad showed me the game Need for Speed, it was the ‘Hot
            Pursuit 2’, and my dad let me play the game before I go to
            kindergarten every day. After all these year growing up with car
            games, I become an engineer studying in University of Cambridge.
            This gets me closer to my dream.
          </p>
          <p>
            In the 2020 summer, I very rarely went outside due to the covid-19
            and I started to officially design a car. Although I am a huge fan
            of JDM, I still appreciate the design of European sport cars. Also,
            I am a stylist so I do want my car to be good looking instead of
            chasing pure aero performance. I have sketched portraits for many
            years as a hobby and this allows me to show my ideas on the paper
            clearly. I have also see CAD engineers at Lotus using CATIA and I
            realize this is a very widely used CAD software in automotive
            industry. Therefore, I brought video courses and started to learn
            it. After hundreds of hours of learning, I think I have the skills I
            need to make my 2D design into 3D in CATIA.
          </p>
          <p>
            And I did it. The model seems a bit default, the curvatures are not
            smooth and windows are bumpy. The rendering in CATIA is not as good
            as SolidWorks, so I learnt to use Keyshot to render and produce
            simple demos of my car.
          </p>
          <p>
            The following are my designs and results of ANSYS CFX for rear wings
            design. Have a look!
          </p>
        </div>
      </div>
